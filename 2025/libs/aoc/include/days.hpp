...
class Days {
   public:
    ...
    DaysError solve(std::int32_t& part_1_example, std::int32_t& part_1,
                    std::int32_t& part_2_example, std::int32_t& part_2) {
    ...
    DaysError solve() {
        std::int32_t part_1_example = 0, part_1 = 0, part_2_example = 0, part_2 = 0;
        return solve(part_1_example, part_1, part_2_example, part_2);
    };

   protected:
    virtual DaysError part_1(std::int32_t& out, bool example = false) = 0;
    virtual DaysError part_2(std::int32_t& out, bool example = false) = 0;
